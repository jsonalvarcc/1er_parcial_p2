                    ...
                    <?php if (count($catastros) > 0): ?>
                        <?php foreach ($catastros as $catastro): ?>
                            <tr>
                                ...
                                <!-- <td>
                                    <a class="btn btn-info" href="#?id=<?php echo $catastro['id']; ?>">Editar</a>
                                    <a class="btn btn-danger" href="eliminar_catastro.php?id=<?php echo $catastro['id']; ?>" onclick="return confirm('¿Estás seguro de que deseas eliminar este catastro?');">Eliminar</a>
                                </td> -->
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
